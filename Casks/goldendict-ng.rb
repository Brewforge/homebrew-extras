cask "goldendict-ng" do
  ...
  url "https://github.com/xiaoyifang/goldendict-ng/releases/download/v#{version.csv.first}-#{version.csv.third}/GoldenDict-#{version.csv.first}-Qt#{version.csv.second}-#{arch}.dmg",
