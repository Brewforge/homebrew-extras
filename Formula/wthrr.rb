class Wthrr < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/ttytm/wthrr-the-weathercrab/releases/download/v#{version}/wthrr-macos-arm64"
    sha256 "ef92e3f9195d39016bc14b40c678d7726e173d484b31e58295e72cde1e8ef383"
    def install
      bin.install "wthrr-macos-arm64"
    end
  elsif OS.mac? && !Hardware::CPU.arm?
    url "https://github.com/ttytm/wthrr-the-weathercrab/releases/download/v#{version}/wthrr-macos-x86_64"
    sha256 "aeb5bd7127a55cf198179cafb1d147de66e3e47e72fbbcaa5d63281c37ecde47"
    def install
      bin.install "wthrr-macos-x86_64"
    end
  elsif !OS.mac? && !Hardware::CPU.arm?
    url "https://github.com/ttytm/wthrr-the-weathercrab/releases/download/v#{version}/wthrr-linux-x86_64"
